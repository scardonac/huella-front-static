...
export const SuccessfulMailing = ({ setTab }) => {
    ...
    return (
        <>
            ...
            <div className="w-2/3">
                <p className="font-normal text-base leading-[22px] tracking-[0.08px] text-color-363f40 text-left opacity-100 mb-4">
                    Revisa tu correo electrónico, te enviamos las instrucciones para restablecer la contraseña.
                </p>
                <p className="font-normal text-base leading-[22px] tracking-[0.08px] text-color-363f40 text-left opacity-100">
